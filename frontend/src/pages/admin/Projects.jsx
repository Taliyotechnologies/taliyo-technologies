...
const Projects = () => {
  ...
  const handleImageFileChange = async (e) => {
    ...
    try {
      ...
      setNewProject(v => ({ ...v, image: data.url }));
    } catch (err) {
  ...
  const handleAddSubmit = async (e) => {
    ...
    try {
      ...
      setNewProject({ title: '', client: '', description: '', startDate: '', endDate: '', budget: '', status: 'planning', priority: 'medium', image: '' });
    } catch (e) {
      setError(e.message || 'Something went wrong');
    }
  };
                ...
                <div className="p-4">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-sm font-medium text-gray-900 dark:text-white">${typeof project.budget === 'number' ? project.budget.toLocaleString() : 0}</span>
                    </div>
                    <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-sm font-medium text-gray-900 dark:text-white">{Array.isArray(project.team) ? project.team.length : 0} members</span>
                    </div>
                  </div>

                  {/* Technologies */}
                  <div className="mt-4 pt-4 border-t border-gray-100 dark:border-gray-700">
                    <p className="text-sm font-medium text-gray-600 dark:text-gray-300 mb-2">Technologies</p>
              ...
              <form className="space-y-4" onSubmit={handleAddSubmit}>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setNewProject(v => ({ ...v, image: e.target.value }))}
                  />
                  {newProject.image && (
                    <div className="mt-2">
                      <img
